...
Процедура КомандаСпеллерТест()
	...
	Для Каждого ТекущийЭлСписка Из мСтрок Цикл
		
		СчСимволов = СчСимволов + СтрДлина(ТекущийЭлСписка.Значение);
	...
	КонецЦикла; // Для Каждого ТекущийЭлСписка Из мСтрок Цикл
